create or replace PACKAGE WSC_AHCS_CENTRAL_VALIDATION_TRANSFORMATION_PKG AS 
...
----------------------------------------------------------------------------------------
   ...
   PROCEDURE leg_coa_transformation(p_batch_id IN number,is_reversal IN number default 0);
   ...
   FUNCTION  IS_VALUE_ZERO(p_string IN number) RETURN NUMBER;
