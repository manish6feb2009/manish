create or replace PACKAGE          "WSC_AP_PKG" AS 
    /* $Header: WSC_AP_PKG.pks  ver 1.0 2021/07/14 16:30:00  $
    +==========================================================================+
    ...
    | =======    ==========  =============         ============================|
    | 1.0        2021/07/14	  JIGYASA KAMTHAN       Initial Version            |
    |                                                                          |
    |                                                                          |
    +==========================================================================+
    */ 
    ...
    --
    -- PARAMETERS: 
    --            IN_WSC_AP_HEADER  WSC_AP_HEADER_T_TYPE_TABLE
    --             
    --
    ...
    --
    -- PARAMETERS: 
    --            IN_WSC_AP_LINE WSC_AP_LINE_T_TYPE_TABLE
    --             
    --
    -- Description : Procedure to insert header level AP details to staging table.
    -- ==============================================================================================
