...
------------------------------------------------------------
-- WSC_AHCS_COA_CONCAT_SEGMENT Success Anixter NEW 222868 SUCCESS 213877
------------------------------------------------------------

SELECT
    COA_NAME COA_MAP_NAME,
    SOURCE_SEGMENT1,
    SOURCE_SEGMENT2,
    SOURCE_SEGMENT3,
    SOURCE_SEGMENT4,
...
FROM
    ...
    and wsc_seq_num is null
order by wsc_seq_num;

------------------------------------------------------------
-- WSC_AHCS_COA_CONCAT_SEGMENT Error Anixter NEW 222868 ERROR 8991
------------------------------------------------------------
