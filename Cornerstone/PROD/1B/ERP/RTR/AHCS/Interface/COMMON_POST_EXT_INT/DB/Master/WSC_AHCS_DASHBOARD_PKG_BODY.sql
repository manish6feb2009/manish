...
Where
--nvl(decode(wais.interface_id,'SALE','SII','CASH','CRI','LSIR','LSI','SPER','SPR','ARIN','ARI',substr(wais.interface_id,1,3)),'X') = nvl(P_SOURCE_SYSTEM,nvl(wais.INTERFACE_ID,'X'))
nvl( decode(decode(wais.interface_id,'SALE','SII','CASH','CRI','LSIR','LSI','SPER','SPR','ARIN','ARI',substr(wais.interface_id,1,3)),'IFR','FII','COQ','CQI','OFR','FTI','INT','ICI','INV','ISI','SPE','SPC','IBI','IBI','IRI','IRI','DAI','DAI','AII','AII',substr(wais.interface_id,1,3)),'X') = nvl(P_SOURCE_SYSTEM,nvl(wais.INTERFACE_ID,'X'))
