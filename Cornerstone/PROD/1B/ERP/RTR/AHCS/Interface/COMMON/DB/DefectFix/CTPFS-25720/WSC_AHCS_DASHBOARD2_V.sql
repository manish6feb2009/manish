...
DR_CR_V.DR,
MAIN_V.NUM_ROW,
 decode(MAIN_V.create_acc_status, 'Final Accounted', 'none', 'Import Pending', 'none', 
 'Accounting Pending', 'none','Draft Accounted','none','Error', 'none','Import Error',  'none',
 decode(MAIN_V.interface_proc_status,'TRANSFORM_SUCCESS',null,'Skipped',null,'OTH'),'none',
               '0')                           dummy,
