create or replace PACKAGE          "WSC_PSFA_PKG" AS 

 /* $Header: WSC_PSFA_PKG.pks  ver 1.0 2021/07/15 12:30:00  $
    +==========================================================================+
   ...
   -- ===============================================================================
    ...
    --
    -- PARAMETERS: 
    --            IN_WSC_AHCS_PSFA_TXN_HEADER  WSC_PSFA_HEADER_T_TYPE_TABLE
    --             
    --
    ...
    --
    -- PARAMETERS: 
    --            IN_WSC_AHCS_PSFA_TXN_LINE  WSC_PSFA_LINE_T_TYPE_TABLE
    --             
    --
    -- Description : Procedure to insert line level PSFA details to staging table.
    -- ==============================================================================================   
...
--create or replace PACKAGE          "WSC_FA_PKG" AS 
--
