...
--                l.je_line_nbr = t.je_line_nbr;
    logging_insert('CENTRAL',p_batch_id,43,'updated line data with header value',null,sysdate);
        ...
        WHERE
            batch_id = p_batch_id;
            commit;
          OPEN failed_lines_count(p_batch_id);
          FETCH failed_lines_count into lv_fail_count;
          CLOSE failed_lines_count;
            
         if lv_fail_count = 0 then
