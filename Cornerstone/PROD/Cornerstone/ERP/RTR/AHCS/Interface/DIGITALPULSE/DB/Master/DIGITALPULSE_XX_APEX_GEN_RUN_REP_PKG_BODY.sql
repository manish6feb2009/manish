SET DEFINE OFF;
/*=====================================================*/
    /* PACKAGE BODY XX_APEX_GEN_RUN_REP_PKG*/
/*=====================================================*/
create or replace PACKAGE BODY  "XX_APEX_GEN_RUN_REP_PKG"  
AS   
 ...
 END convert_blob_to_xmltype;   
  ...
  AS   
    ...
    x_envelope := '<soap:Envelope xmlns:pub="http://xmlns.oracle.com/oxp/service/PublicReportService" xmlns:soap="http://www.w3.org/2003/05/soap-envelope">   
                ...
                <pub:attributeFormat>xml</pub:attributeFormat>   
                   ...
                   <!--Zero or more repetitions:-->   
                    <pub:item>	   
                     ...
                     <pub:values>   
                         <!--Zero or more repetitions:-->   
                         <pub:item>'||TO_CHAR(x_full_query)||'</pub:item>   
                      </pub:values>   
                   </pub:item>   
                </pub:parameterNameValues>    
  	...
  	--dbms_output.put_line(x_encrypt_output);   
  	   convert_blob_to_xmltype(x_encrypt_blob,x_xml_out);   
         
       x_xml_data_out := x_xml_out;  
