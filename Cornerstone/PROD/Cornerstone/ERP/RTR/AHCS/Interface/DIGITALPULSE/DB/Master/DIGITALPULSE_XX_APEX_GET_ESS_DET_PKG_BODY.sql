SET DEFINE OFF;
/*=====================================================*/
    /* PACKAGE BODY XX_APEX_GET_ESS_DET_PKG */
/*=====================================================*/

create or replace PACKAGE BODY  "XX_APEX_GET_ESS_DET_PKG" as    
...
--DBMS_OUTPUT.PUT_LINE('Hi');    
    ...
    v_max_time := NVL(v_max_time, sysdate -15);    
...
BEGIN   
    ...
    l_clob := apex_web_service.make_rest_request(    
        p_url => x_url || ':443/ic/api/integration/v1/flows/rest/XXSEC_FIN_DP_JOB_REPOR_INT/1.0/runDpReport',    
        p_http_method => 'POST',    
...
--DBMS_OUTPUT.PUT_LINE('Hi');    
   ...
   l_xml_result := apex_json.get_varchar2 ('p_result');    
      ...
      x_encrypt_blob:= base64DecodeClobAsBlob(l_xml_result);   
       ...
       /*insert into XX_INTERM_XML_OUTPUT values (x_xml_output);  
       commit; */ 
