create or replace PACKAGE wsc_ahcs_cncr_validation_transformation_pkg AS 

------------------------------------------------------------------------------------------------------------------------------------------------------------
-- PACKAGE             WSC_AHCS_CNCR_VALIDATION_TRANSFORMATION_PKG AS
------------------------------------------------------------------------------------------
...
-- $Header: WSC_AHCS_CNCR_VALIDATION_TRANSFORMATION_PKG.pkg
--
-- PRE-REQUISITES
...
-- =================              ===========  ===   ====================================
-- Deloitte Consulting            29-AUG-2022  1.0   Created
--
----------------------------------------------------------------------------------------
