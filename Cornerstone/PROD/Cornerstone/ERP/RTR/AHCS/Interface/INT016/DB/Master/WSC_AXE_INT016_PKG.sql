create or replace PACKAGE wsc_cncr_pkg AS 

  /* $Header: wsc_cncr_pkg.pks  ver 1.0 2022/08/29 01:00:00  $
    +==========================================================================+
    ...
    | =======    ==========  =============         ============================|
    | 1.0        2022/08/29	  Syed Zafer Ali    Initial Version            |
    |                                                                          |
    |                                                                          |
    +==========================================================================+
    */
    ...
    --             
    --
    -- Description : Procedure to import concur data from ftp to temporary ar staging table.
    -- ====================================================================================================
    PROCEDURE wsc_cncr_insert_data_temp_p (
...
-- ================================================================================================
    ...
    --             p_file_name 
    --
    -- Description : Procedure to split concur data from temporary stage table to header and line table and update header_id to line, insert data to status table.
    -- ==========================================================================================================================================================
    PROCEDURE wsc_process_cncr_temp_to_header_line_p (
