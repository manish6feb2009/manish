...
--   Date and Time:   11:18 Tuesday July 11, 2023
...
,p_last_upd_yyyymmddhh24miss=>'20230707140049'
...
'                WHERE',
'                    ap.status = ''''ERROR'''' and ap.invoice_number not like ''''%LSI''''',
'                UNION',
'                SELECT',
'                batch_id,',
'                    to_number(intercompany_batch_number)        id,',
...
,p_page_is_public_y_n=>'Y'
,p_last_updated_by=>'nobody'
,p_last_upd_yyyymmddhh24miss=>'20230629180807'
);
wwv_flow_api.create_page_plug(
