create or replace PACKAGE          "WSC_AHCS_AR_VALIDATION_TRANSFORMATION_PKG" AS 
------------------------------------------------------------------------------------------------------------------------------------------------------------
-- PACKAGE             WSC_GL_AR_VALIDATION_TRANSFORMATION_PKG AS
------------------------------------------------------------------------------------------
...
-- $Header: WSC_GL_AR_VALIDATION_TRANSFORMATION_PKG.pkg
--
-- PRE-REQUISITES
