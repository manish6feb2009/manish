...
--| Module/Object Name  : WSC_AHCS_AR_TXN_HEADER_T.sql
--|
--| Description         : Object to create staging table for EBS AR Header Script
--|
...
--+========================================================================|
  ...
  CREATE TABLE "FININT"."WSC_AHCS_AR_TXN_HEADER_T" 
   (	"HEADER_ID" NUMBER, 
	"BATCH_ID" NUMBER, 
	...
	"ACC_DATE" DATE, 
	"HEADER_DESC" VARCHAR2(1000 BYTE), 
	...
	"LEG_TRNS_TYPE" VARCHAR2(100 BYTE), 
	...
	"ATTRIBUTE11" DATE, 
	"ATTRIBUTE12" DATE, 
	 CONSTRAINT "WSC_AHCS_AR_TXN_HEADER_T_PK" PRIMARY KEY ("HEADER_ID"));

--+========================================================================|
--| RICE_ID             : INT005 - WESCO EBS AR Inbound to AHCS
--| Module/Object Name  : WSC_AHCS_AR_TXN_LINE_T.sql
--|
--| Description         : Object to create staging table for EBS AR Line Script
--|
--| Creation Date       : 06-SEPT-2021
--|
--| Author              : Jigyasa Kamthan
...
--+========================================================================|
  ...
  CREATE TABLE "FININT"."WSC_AHCS_AR_TXN_LINE_T" 
   (	"LINE_ID" NUMBER, 
	"BATCH_ID" NUMBER, 
	"HEADER_ID" NUMBER, 
	"TRANSACTION_NUMBER" VARCHAR2(100 BYTE), 
	...
	"ATTRIBUTE11" DATE, 
	"ATTRIBUTE12" DATE, 
	 CONSTRAINT "WSC_AHCS_AR_TXN_LINE_T_PK" PRIMARY KEY ("LINE_ID")) ;
