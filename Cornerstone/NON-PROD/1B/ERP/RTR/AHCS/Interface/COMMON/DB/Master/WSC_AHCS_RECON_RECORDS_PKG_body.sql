...
DBMS_MVIEW.REFRESH('WSC_AHCS_DSHB2_UNI_REC_V','C');
DBMS_MVIEW.REFRESH('WSC_AHCS_DSHB2_DR_CR_V','C');
DBMS_MVIEW.REFRESH('WSC_AHCS_DSHB2_MAIN_V','C');
 ...
 Execute immediate 'Truncate table WSC_AHCS_DASHBOARD2_STAGE_T'; 
  ...
  Insert into WSC_AHCS_DASHBOARD2_STAGE_T (APPLICATION,
    ...
    DUMMY,
    DUMMY4,
    SOURCE_SYSTEM) select APPLICATION,
    ACCOUNTING_PERIOD,
    INTERFACE_PROC_STATUS,
    CREATE_ACC_STATUS,
    TOTAL_CR,
    ...
    DUMMY,
    DUMMY4,
    SOURCE_SYSTEM from WSC_AHCS_DASHBOARD2_V;
  ...
  Insert into WSC_AHCS_DASHBOARD2_T (APPLICATION,
    ...
    DUMMY,
    DUMMY4,
    SOURCE_SYSTEM from WSC_AHCS_DASHBOARD2_STAGE_T;
