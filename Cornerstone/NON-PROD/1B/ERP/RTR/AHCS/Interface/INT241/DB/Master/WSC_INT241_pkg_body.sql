    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            logging_insert('JTI_MFINV', p_batch_id, 102, 'Error in WSC_JTI_MFINV_INSERT_DATA_IN_GL_STATUS_P proc', sqlerrm,
                          sysdate);
            wsc_ahcs_int_error_logging.error_logging(p_batch_id, 'INT241_MFINV', 'JTI_MFINV', sqlerrm);
            dbms_output.put_line(sqlerrm);
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            logging_insert('MF AP', p_batch_id, 102, 'Error in WSC_JTI_MFAP_INSERT_DATA_IN_GL_STATUS_P proc', sqlerrm,
                          sysdate);
            wsc_ahcs_int_error_logging.error_logging(p_batch_id, 'INT241_MFAP', 'JTI_MFAP', sqlerrm);
            dbms_output.put_line(sqlerrm);
