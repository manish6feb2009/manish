create or replace PACKAGE wsc_ahcs_mfar_validation_transformation_pkg AS 

------------------------------------------------------------------------------------------------------------------------------------------------------------
-- PACKAGE             WSC_AHCS_MFAR_VALIDATION_TRANSFORMATION_PKG AS
------------------------------------------------------------------------------------------
...
-- $Header: WSC_AHCS_MFAR_VALIDATION_TRANSFORMATION_PKG.pkg
--
-- PRE-REQUISITES
