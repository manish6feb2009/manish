create or replace PACKAGE          "WSC_AHCS_PSFA_VALIDATION_TRANSFORMATION_PKG" AS 
------------------------------------------------------------------------------------------------------------------------------------------------------------
-- PACKAGE             WSC_AHCS_PSFA_VALIDATION_TRANSFORMATION_PKG AS
------------------------------------------------------------------------------------------
...
-- $Header: WSC_AHCS_PSFA_VALIDATION_TRANSFORMATION_PKG.pkg
--
-- PRE-REQUISITES
...
---- Name                           Date           Ver   Description
---- =================              ===========    ===   ====================================
---- Deloitte Consulting            03-MARCH-2022  1.0   Created
----
------------------------------------------------------------------------------------------
--
--   PROCEDURE data_validation(p_batch_id IN number);
