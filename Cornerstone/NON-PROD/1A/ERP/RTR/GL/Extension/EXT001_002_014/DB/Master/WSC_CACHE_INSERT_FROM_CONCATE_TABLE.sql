...
-----------------------------------------------------------------------------------
--WESCO to cloud, insert wsc_gl_ccid_mapping_t
-----------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------
--Central to cloud, insert wsc_gl_ccid_mapping_t
-----------------------------------------------------------------------------------
...
from 
  (
    select distinct
      3 COA_MAP_ID, 
      'Y' ENABLE_FLAG, 
      SOURCE_SEGMENT1 || '.' || SOURCE_SEGMENT2 SOURCE_SEGMENT, 
      TARGET_COA TARGET_SEGMENT, 
      sysdate CREATION_DATE, 
      sysdate LAST_UPDATE_DATE, 
      'Central to Cloud' COA_MAP_NAME, 
      'N' UI_FLAG, 
      SOURCE_SEGMENT1, 
      SOURCE_SEGMENT2
    from 
    ...
    where 
      ...
      and coa_name = 'Central to Cloud'
  );
commit;

-----------------------------------------------------------------------------------
--POC to cloud, insert wsc_gl_ccid_mapping_t
-----------------------------------------------------------------------------------
