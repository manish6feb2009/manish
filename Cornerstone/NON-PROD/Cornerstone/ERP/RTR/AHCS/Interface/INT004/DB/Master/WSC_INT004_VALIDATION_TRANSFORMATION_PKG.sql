--------------------------------------------------------
--   Package WSC_AHCS_FA_VALIDATION_TRANSFORMATION_PKG
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE "FININT"."WSC_AHCS_FA_VALIDATION_TRANSFORMATION_PKG" AS 
------------------------------------------------------------------------------------------------------------------------------------------------------------
-- PACKAGE             WSC_AHCS_FA_VALIDATION_TRANSFORMATION_PKG AS
------------------------------------------------------------------------------------------
...
-- $Header: WSC_AHCS_FA_VALIDATION_TRANSFORMATION_PKG.pkg
--
-- PRE-REQUISITES
