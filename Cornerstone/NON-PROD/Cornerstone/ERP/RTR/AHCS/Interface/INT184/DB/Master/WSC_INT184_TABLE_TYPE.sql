create or replace TYPE "WSC_PSFA_HEADER_T_TYPE" FORCE AS  OBJECT
(	"BATCH_ID" NUMBER, 
	"HEADER_ID" NUMBER, 
	"HDR_SEQ_NBR" NUMBER,
	"FISCAL_YEAR" NUMBER, 
	...
	"ACCOUNTING_DATE" VARCHAR2(30 BYTE), 
...
create or replace TYPE "WSC_PSFA_HEADER_T_TYPE_TABLE" force
AS TABLE OF WSC_PSFA_HEADER_T_TYPE;


/

create or replace TYPE  "WSC_PSFA_LINE_T_TYPE" FORCE AS OBJECT 
(	"BATCH_ID" NUMBER, 
	"LINE_ID" NUMBER,
	"HEADER_ID" NUMBER, 
	...
	"ATTRIBUTE4" NUMBER, 
	"ATTRIBUTE5" NUMBER, 
	"ATTRIBUTE6" VARCHAR2(20 BYTE), 
	"ATTRIBUTE7" VARCHAR2(20 BYTE), 
	"ATTRIBUTE8" VARCHAR2(240 BYTE), 
	"ATTRIBUTE9" VARCHAR2(240 BYTE), 
	"ATTRIBUTE10" VARCHAR2(240 BYTE), 
	"ATTRIBUTE11" VARCHAR2(1000 BYTE), 
...
create or replace TYPE "WSC_PSFA_LINE_T_TYPE_TABLE" force
AS TABLE OF WSC_PSFA_LINE_T_TYPE;
