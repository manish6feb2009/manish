...
/* $Header: wsc_ahcs_PSFA_validation_transformation_pkg.pkb  ver 1.0 2021/07/15 12:30:00  $
    +==========================================================================+
    ...
    |                                                                          |
    |  FILENAME                                                                |
    |    wsc_ahcs_PSFA_validation_transformation_pkg.pkb                                    |
    |                                                                          |
    |  DESCRIPTION     										                   |
    |                                                                          |
    |  HISTORY                                                                 |
    ...
    | 2.0        2023/11/01   Satya                 JIRA # OC-111              |
                                                   As GL Accountant 
                                                   I need AHCS specific to 
                                                   PSFA subledger to use 
                                                   updated inbound file 
                                                   layout & mapping intercompany 
                                                   from source file to 
                                                   derive future cloud IC segment. 
    |                                                                          |
    +==========================================================================+
    */ 
   ...
   ------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        SELECT DISTINCT
            ...
            line.LOCATION,
            line.ANIXTER_VENDOR,
            line.LEG_AFFILIATE,   --- --- Added on 11-01-2023 for JIRA # OC-111
...
--        update target_coa and attribute1 'Y' in PSFA_line table where distinct leg_coa and target_coa is null      
	 ...
	 UPDATE wsc_ahcs_PSFA_txn_line_t tgt_coa
            SET target_coa = replace(wsc_gl_coa_mapping_pkg.coa_mapping(lv_src_system, lv_tgt_system, tgt_coa.UNIT, 
                tgt_coa.LOCATION,tgt_coa.DEPT_ID,tgt_coa.ACCOUNT,tgt_coa.ANIXTER_VENDOR,tgt_coa.LEG_AFFILIATE, --- Added on 11-01-2023 for JIRA # OC-111
                 null,null,NULL,NULL),' ',''),
                attribute1 = 'Y'
            WHERE
                    batch_id = p_batch_id
            ...
            LOOP
                ...
                FORALL i IN 1..lv_inserting_ccid_table.count
                    INSERT INTO wsc_gl_ccid_mapping_t (
                        ...
                        lv_inserting_ccid_table(i).LEG_AFFILIATE, --- Added on 11-01-2023 for JIRA # OC-111
                        null,
                        null,
                        null,
                        null
...
/**** @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ ******/
   ...
   ------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        SELECT DISTINCT
            ...
            line.LOCATION,
            line.ANIXTER_VENDOR,
            line.LEG_AFFILIATE,   --- --- Added on 11-01-2023 for JIRA # OC-111---'00000',
            substr(line.LEG_COA,instr(line.LEG_COA,'.',1,7)+1) as ledger_name
        FROM
            wsc_ahcs_PSFA_txn_line_t    line
        WHERE
...
--        update target_coa and attribute1 'Y' in PSFA_line table where distinct leg_coa and target_coa is null      
	 ...
	 UPDATE wsc_ahcs_PSFA_txn_line_t tgt_coa
            SET target_coa = replace(wsc_gl_coa_mapping_pkg.coa_mapping(lv_src_system, lv_tgt_system, tgt_coa.UNIT, 
                tgt_coa.LOCATION,tgt_coa.DEPT_ID,tgt_coa.ACCOUNT,tgt_coa.ANIXTER_VENDOR, tgt_coa.LEG_AFFILIATE,   --- --- Added on 11-01-2023 for JIRA # OC-111--'00000',
                 null,null,NULL,NULL),' ',''),
                attribute1 = 'Y'
            WHERE
                    batch_id = p_batch_id
            ...
            LOOP
                ...
                FORALL i IN 1..lv_inserting_ccid_table.count
                    INSERT INTO wsc_gl_ccid_mapping_t (
                        ...
                        lv_inserting_ccid_table(i).ACCOUNT,
                        lv_inserting_ccid_table(i).ANIXTER_VENDOR,
                        lv_inserting_ccid_table(i).LEG_AFFILIATE,   ---'00000',Added on 11-01-2023 for JIRA # OC-111
                        null,
                        null,
                        null,
                        null
